...
<html>
  ...
  <body class="gray-bg">
                                ...
                                <div class="example-wrap">
                                    <div class="example">
                                        <div id="toolbar" class="btn-group m-t-sm">
                                            <button type="button" class="btn btn-default"  title="创建角色" onclick="role_show('创建角色','${ctx}/system/sysrole/list/add',null,null,'900',null)">
    ...
    <!-- 自定义js -->
    <script src="${ctxsta}/admin/main/js/sysrole-list.js"></script>
    </meFooter>

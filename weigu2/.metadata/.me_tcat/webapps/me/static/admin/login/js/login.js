...
function showsectime() {
	var birthDay =NewDate("2016-11-23");
	var today=new Date();
...
$(function(){
	$('.submit_btn').click(function () { 
		...
		type:'post',
		dataType:'json',
		data: {"systemUser.loginName":loginName,"systemUser.loginPassword":loginPassword,"registerCode":registerCode,"systemUser.type":type},
...
//					$("input[name='systemUser.loginPassword']").css("background","green");

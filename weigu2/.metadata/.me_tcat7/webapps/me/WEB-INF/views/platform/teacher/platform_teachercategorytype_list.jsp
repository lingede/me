...
<html>
  ...
  <body>
                                ...
                                <div class="example-wrap">
                                    <div class="example">
                                        <div id="toolbar" class="btn-group m-t-sm">
                                            <button type="button" class="btn btn-default"  title="添加教师职称类型" onclick="teachercategorytype_show('添加教师职称类型','${ctx}/platform/teachercategorytype/list/add',null,null,'900',null)">
                                        ...
                                        <tr>
                                            ...
                                            <th data-halign="center" data-align="center" data-sortable="true">类型名称</th>
                                        ...
                                        <tr>
                                            <td>${teachercategorytype.name}</td>
                                            <td>${teachercategorytype.fsort}</td>
                                           
                                            
                                            <td class="td-manage">  
                                           
                                            <a class="edit m-l-sm text-warning" href="javascript:void(0)" onclick="teachercategorytype_show('${teachercategorytype.name}','${ctx}/platform/teachercategorytype/list','${teachercategorytype.id}','edit','900',null)" title="修改">
                                            <i class="glyphicon glyphicon-edit"></i>
                                            </a>
                                            <a class="remove m-l-sm text-danger" href="javascript:void(0)" onclick="teachercategorytype_del(this,${teachercategorytype.id})" title="删除">
    ...
    <!-- 自定义js -->
    <script src="${ctxsta}/platform/js/teacher/teachercategorytype-list.js"></script>
    </meFooter>
  </body>
</html>

...
<html>
  ...
  <body class="system-message gray-bg">
                                ...
                                <div class="example-wrap">
                                    <div class="example">
                                    	<div id="toolbar" class="btn-group m-t-sm">
                                            <button type="button" class="btn btn-default"  title="添加可维护页" onclick="maintainablepage_show('创建可维护页','${ctx}/platform/maintainablepage/list/add',null,null,'900',null)">
                                        ...
                                        <tr>
                                            ...
                                            <th data-halign="center" data-align="center">阅读次数</th>
                                            <th data-halign="center" data-align="center">操作</th>
                                        </tr>
                                        </thead>
                                        <tbody>
                                        	<c:forEach items="${maintainablepages}" var="maintainablepage">
                                        		<tr>
		                                            <td>${maintainablepage.categoryId}</td>
		                                            <td>${maintainablepage.title}</td>
		                                            <td>${maintainablepage.numOfRead}</td>
		                                            <td class="td-manage">
		                                            	<a class="edit m-l-sm text-warning" href="javascript:void(0)" onclick="maintainablepage_show('编辑可维护页','${ctx}/platform/maintainablepage/list','${maintainablepage.id}','edit','900',null)" title='编辑'>
		                                            	<i class="glyphicon glyphicon-edit"></i></a>
		                                            	<a class="remove m-l-sm text-danger" href="javascript:void(0)" onclick="maintainablepage_del(this,${maintainablepage.id})" title="删除">
	...
	<!-- 自定义js -->
    <script src="${ctxsta}/platform/js/category/maintainablepage-list.js"></script>
    </meFooter>
  </body>
</html>
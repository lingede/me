                                    ...
                                    <div class="example">
                                        ...
                                        <tr>
                                            ...
                                            <td class="td-manage">  
	                                            ...
	                                            <a class="remove m-l-sm text-primary" href="javascript:void(0)" onclick="member_show('${team.name}','${ctx}/platform/teamteacher/list','${team.id}','list','900',null)" title="管理团队成员">
	                                            <i class="glyphicon glyphicon-user"></i>
                                            </a>
                                            </td>
                                             <td class="td-manage">  
	                                            <a class="remove m-l-sm text-primary" href="javascript:void(0)" onclick="member_show('${team.name}','${ctx}/platform/team/list','${team.id}/1','editdata','900',null)" title="管理研究领域">
	                                             <span class="glyphicon glyphicon glyphicon-cog"></span> 领域
	                                            </a>
	                                            
	                                            <a class="remove m-l-sm text-primary" href="javascript:void(0)" onclick="member_show('${team.name}','${ctx}/platform/team/list','${team.id}/2','editdata','900',null)" title="管理成果">
	                                             <span class="glyphicon glyphicon glyphicon-cog"></span> 学术
	                                            </a>
	                                            
	                                            <a class="remove m-l-sm text-primary" href="javascript:void(0)" onclick="member_show('${team.name}','${ctx}/platform/team/list','${team.id}/3','editdata','900',null)" title="管理学生培养">
